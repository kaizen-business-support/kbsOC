...
async function main() {
  ...
  if (activePolicy) {
    ...
    const defaultSteps = [
      ...
      { stepName: 'formalisation_garanties',   stepLabel: 'Formalisation des garanties',      order: 10, stepType: 'LEGAL',     assignedRole: 'DIRECTION_JURIDIQUE',     phase: 'Mise en place',    expectedDurationHours: 48,  maxDurationHours: 120 },
      { stepName: 'saisie_garanties',          stepLabel: 'Saisie des garanties',             order: 11, stepType: 'LEGAL',     assignedRole: 'DIRECTION_JURIDIQUE',     phase: 'Mise en place',    expectedDurationHours: 24,  maxDurationHours: 72  },
