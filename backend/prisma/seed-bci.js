...
async function main() {
  ...
  if (activePolicy) {
    ...
    const defaultSteps = [
      ...
      { stepName: 'mise_en_place_sib',         stepLabel: 'Mise en place SIB',                order: 9,  stepType: 'ANALYSIS',  assignedRole: 'RESPONSABLE_ENGAGEMENTS', phase: 'Mise en place',    expectedDurationHours: 48,  maxDurationHours: 120, allowedActions: ['approve', 'transfer'] },
      ...
      { stepName: 'tirage_fonds',              stepLabel: 'Tirage des fonds',                 order: 12, stepType: 'ANALYSIS',  assignedRole: 'BACK_OFFICE',             phase: 'Mise en place',    expectedDurationHours: 24,  maxDurationHours: 48,  allowedActions: ['approve', 'transfer'] },
      { stepName: 'back_office_setup',         stepLabel: 'Mise en place back-office',        order: 13, stepType: 'ANALYSIS',  assignedRole: 'BACK_OFFICE',             phase: 'Mise en place',    expectedDurationHours: 24,  maxDurationHours: 48,  allowedActions: ['approve', 'transfer'] },
    ];
