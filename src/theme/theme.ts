  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        outlined: {
          borderColor:          'rgba(58,86,168,0.25)',
          color:                brand.deep,
          ...
          '&:hover': {
            ...
            boxShadow:   '0 2px 10px rgba(58,86,168,0.10)',
          },
        },
        text: {
          color:     brand.deep,
    ...
    MuiChip: {
      styleOverrides: {
        ...
        colorPrimary: { background: 'rgba(58,86,168,0.10)', color: brand.deep,  border: `1px solid rgba(58,86,168,0.20)` },
        colorSecondary:{ background: 'rgba(40,168,226,0.10)', color: brand.mid, border: `1px solid rgba(40,168,226,0.22)` },
        colorSuccess: { backgroundColor: '#ECFDF3', color: '#027A48', border: '1px solid #ABEFC6' },
        colorError:   { backgroundColor: '#FEF3F2', color: '#B42318', border: '1px solid #FECDCA' },
        colorWarning: { backgroundColor: '#FFFAEB', color: '#B54708', border: '1px solid #FEDF89' },
        colorInfo:    { background: 'rgba(40,168,226,0.10)', color: '#1E7DB5', border: `1px solid rgba(40,168,226,0.22)` },
      },
    },
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        outlined: { borderColor: 'rgba(40,168,226,0.25)', color: brand.sky },
        text:     { color: brand.sky },
      },
    },
    MuiTableContainer: {
      styleOverrides: {
